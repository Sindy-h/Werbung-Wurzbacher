import React, { 
  ...
  useEffect, 
  useState 
} from 'react' // <--- Hier KEIN 'type' davor!

import type { ComponentPropsWithRef } from 'react' // <--- Das ist nur ein Typ
import type { EmblaCarouselType } from 'embla-carousel' // <--- Das auch
